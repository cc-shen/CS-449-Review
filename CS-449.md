...
1. Give 2 examples of _user story_ in the correct format.  As a user, I want to be able to write down all the things that I often forget, so that I can check what I need to do before leaving the house. As a user, I want to be reminded to lock the door as I leave the house
